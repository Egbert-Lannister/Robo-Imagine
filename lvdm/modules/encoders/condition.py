...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, arch="ViT-H-14", local_path="/nas/101data/wangconglin/models/open_clip_pytorch_model.bin", device="cuda", max_length=77,
        ...
        # 2️⃣ 加载本地权重
        print(f"🔽 Loading local CLIP model weights from {local_path}")
...
class FrozenOpenCLIPImageEmbedderV2(AbstractEncoder):
    ...
    def __init__(self, arch="ViT-H-14", local_path="/nas/101data/wangconglin/models/open_clip_pytorch_model.bin", device="cuda",
